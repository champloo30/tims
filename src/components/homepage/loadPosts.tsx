...
const LoadPosts = () => {
  return (
    <div className='h-10 w-full flex justify-center items-center gap-2 bg-purple text-old-lace cursor-pointer' title='Load New Posts' aria-label='Load New Posts'>
      <svg className='h-6 w-6 fill-old-lace' version="1.1" id="_x32_" 
	 viewBox="0 0 512 512">
        <g>
