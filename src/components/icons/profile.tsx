...
const Profile = () => {
  return (
    <svg className='h-7 w-7' viewBox="0 0 20 20" version="1.1">
      <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="Dribbble-Light-Preview" transform="translate(-420.000000, -2159.000000)" className='fill-purple dark:fill-violet'>
