...
const GoBack: React.FC<GoBackProps> = ({ href, location }) => {
  return (
    <Link href={href} title={`Back To ${location}`} aria-label={`Back To ${location}`}>
      <svg className='h-6 w-6 fill-purple dark:fill-violet' version="1.1" viewBox="0 0 472.615 472.615">
        <g>
          <g>
